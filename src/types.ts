...
export type AddUserMutationMutation = {
    __typename?: 'Mutation';
    addUser?: { __typename?: 'User'; name?: string | null; id: string; age?: number | null } | null;
};
...
export type UsersQueryQuery = {
    __typename?: 'Query';
    users?: Array<{ __typename?: 'User'; name?: string | null; id: string; age?: number | null } | null> | null;
};
...
export type AddUserMutationMutationFn = Apollo.MutationFunction<
    ...
    AddUserMutationMutationVariables
>;
...
export function useAddUserMutationMutation(
    baseOptions?: Apollo.MutationHookOptions<AddUserMutationMutation, AddUserMutationMutationVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<AddUserMutationMutation, AddUserMutationMutationVariables>(
...
export function useUsersQueryLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<UsersQueryQuery, UsersQueryQueryVariables>,
) {
    const options = { ...defaultOptions, ...baseOptions };
